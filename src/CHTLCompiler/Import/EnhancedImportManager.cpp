...
void EnhancedImportManager::setModulePathManager(std::shared_ptr<common::ModulePathManager> pathManager) {
    pathManager_ = pathManager;
}

void EnhancedImportManager::setErrorHandler(std::shared_ptr<common::ErrorHandler> errorHandler) {
    errorHandler_ = errorHandler;
}

// === 导入语句解析 - 严格按照CHTL语法文档 ===

bool EnhancedImportManager::parseHtmlImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseCssImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseJavaScriptImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseChtlImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseCJmodImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseConfigImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseOriginImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseCustomImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseTemplateImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseBatchImport(const std::string& statement, EnhancedImportStatement& result) {
...
bool EnhancedImportManager::parseImportStatement(const std::string& statement, EnhancedImportStatement& result) {
    // 主解析函数 - 自动识别导入类型
...
bool EnhancedImportManager::addImport(const EnhancedImportStatement& import) {
    // 检查重复导入
...
bool EnhancedImportManager::checkCircularDependencies() {
...
bool EnhancedImportManager::checkDuplicateImports() {
...
bool EnhancedImportManager::resolveAllDependencies() {
...
void EnhancedImportManager::clear() {
    imports_.clear();
    resolvedImports_.clear();
    errors_.clear();
...
bool EnhancedImportManager::extractFromClause(const std::string& statement, std::string& path) {
...
bool EnhancedImportManager::extractAsClause(const std::string& statement, std::string& alias) {
...
bool EnhancedImportManager::isValidPath(const std::string& path) {
...
void EnhancedImportManager::reportError(const std::string& message, int line, int column) {
...
void EnhancedImportManager::reportPathError(const std::string& path, const std::string& context) {
