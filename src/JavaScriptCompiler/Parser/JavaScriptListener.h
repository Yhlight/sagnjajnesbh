...
public:
  ...
  virtual void enterAnonymousFunctionExpression(JavaScriptParser::AnonymousFunctionExpressionContext *ctx) = 0;
  virtual void exitAnonymousFunctionExpression(JavaScriptParser::AnonymousFunctionExpressionContext *ctx) = 0;
  ...
  virtual void enterAnonymousFunction(JavaScriptParser::AnonymousFunctionContext *ctx) = 0;
  virtual void exitAnonymousFunction(JavaScriptParser::AnonymousFunctionContext *ctx) = 0;
